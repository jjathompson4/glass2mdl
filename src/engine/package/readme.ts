...
export function buildReadme(options: {
  ...
  if (input.rollerWave) {
    lines.push(
      ...
      "glass. This export ships it as roller_wave_bump.png, a grayscale",
      "height map (bright = high). It shows only in a rendered reflection",
      "at a shallow angle, never in the viewport.",
      "",
